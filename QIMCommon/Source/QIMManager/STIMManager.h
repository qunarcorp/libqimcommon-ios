...
@class UserInfo,STIMMessageModel;
@interface STIMManager : NSObject
...
@property (nonatomic, strong) STIMMessageModel *msg;    //获取历史消息用的模型
...
@interface STIMManager (CommonConfig)
