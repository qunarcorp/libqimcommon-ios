...
//- (id) initWithCheckingDomain:(NSString *) domain;
...
@protocol ProtobufReconnectDelegate
@optional
...
- (void)xmppReconnect:(ProtobufReconnector *)sender didDetectAccidentalDisconnect:(SCNetworkConnectionFlags)connectionFlags;
- (BOOL)xmppReconnect:(ProtobufReconnector *)sender shouldAttemptAutoReconnect:(SCNetworkConnectionFlags)connectionFlags;

#else

- (void)xmppReconnect:(ProtobufReconnector *)sender didDetectAccidentalDisconnect:(SCNetworkReachabilityFlags)connectionFlags;

- (BOOL)xmppReconnect:(ProtobufReconnector *)sender shouldAttemptAutoReconnect:(SCNetworkReachabilityFlags)reachabilityFlags;
