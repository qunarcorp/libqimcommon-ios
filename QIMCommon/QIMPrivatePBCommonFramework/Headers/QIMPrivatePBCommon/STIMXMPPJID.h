...
@interface STIMXMPPJID : NSObject <NSCoding, NSCopying>
...
+ (STIMXMPPJID *)jidWithString:(NSString *)jidStr;
+ (STIMXMPPJID *)jidWithString:(NSString *)jidStr resource:(NSString *)resource;
+ (STIMXMPPJID *)jidWithUser:(NSString *)user domain:(NSString *)domain resource:(NSString *)resource;
 ...
 **/
- (STIMXMPPJID *)jidWithNewResource:(NSString *)resource;

- (BOOL)isEqualToJID:(STIMXMPPJID *)aJID;

- (BOOL)isEqualToJID:(STIMXMPPJID *)aJID options:(XMPPJIDCompareOptions)mask;
