...
#import "STIMPBStream.h"

@protocol STIMPBStackDelegate <NSObject>
@required
- (void) beginToConnect;
- (void) beenConnected;
- (void) loginComplate;
...
@interface STIMPBStack : NSObject
...
@property (nonatomic, weak) id<STIMPBStackDelegate> delegate;
