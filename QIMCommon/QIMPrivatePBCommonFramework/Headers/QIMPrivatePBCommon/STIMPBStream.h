...
@class GCDAsyncSocket, STIMXMPPJID, ProtoMessage, IQMessage, PresenceMessage;
...
@interface STIMPBStream : NSObject
// test
+ (void)testSTIMPBStream;
...
@property(readwrite, copy) STIMXMPPJID *myJID;
...
- (void)registerModule:(STIMProtobufModel *)reconnector;

- (void)unregisterModule:(STIMProtobufModel *)reconnector;
 ...
 **/
- (void)pbXmppStreamWillConnect:(STIMPBStream *)sender;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender socketDidConnect:(GCDAsyncSocket *)socket;
 ...
 **/
- (void)pbXmppStreamDidStartNegotiation:(STIMPBStream *)sender;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender willSecureWithSettings:(NSMutableDictionary *)settings;
 ...
 **/
- (void)pbXmppStreamDidSecure:(STIMPBStream *)sender;
 ...
 **/
- (void)pbXmppStreamDidConnect:(STIMPBStream *)sender;
 ...
 **/
- (void)pbXmppStreamDidRegister:(STIMPBStream *)sender;

/**
 * This method is called if registration fails.
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didNotRegister:(ProtoMessage *)error;

/**
 * This method is called after authentication has successfully finished.
 * If authentication fails for some reason, the xmppStream:didNotAuthenticate: method will be called instead.
 **/
- (void)pbXmppStreamDidAuthenticate:(STIMPBStream *)sender;

/**
 * This method is called if authentication fails.
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didNotAuthenticate:(ProtoMessage *)error;
 ...
 **/
- (NSString *)pbXmppStream:(STIMPBStream *)sender alternativeResourceForConflictingResource:(NSString *)conflictingResource;
 ...
 **/
- (id)pbXmppStream:(STIMPBStream *)sender willReceiveIQ:(id)iq;

- (id)pbXmppStream:(STIMPBStream *)sender willReceiveMessage:(id)message;

- (id)pbXmppStream:(STIMPBStream *)sender willReceivePresence:(id)presence;
 ...
 **/
- (BOOL)pbXmppStream:(STIMPBStream *)sender didReceiveIQ:(IQMessage *)iq;

- (void)pbXmppStream:(STIMPBStream *)sender didReceiveMessage:(ProtoMessage *)message;

- (void)pbXmppStream:(STIMPBStream *)sender didReceivePresenceKeyNotify:(PresenceMessage *)pMessage;

- (void)pbXmppStream:(STIMPBStream *)sender didReceivePresence:(PresenceMessage *)presence;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didReceiveError:(ProtoMessage *)error;
 ...
 **/
- (id)pbXmppStream:(STIMPBStream *)sender willSendIQ:(id)iq;

- (id)pbXmppStream:(STIMPBStream *)sender willSendMessage:(id)message;

- (id)pbXmppStream:(STIMPBStream *)sender willSendPresence:(id)presence;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didSendIQ:(id)iq;

- (void)pbXmppStream:(STIMPBStream *)sender didSendMessage:(id)message;

- (void)pbXmppStream:(STIMPBStream *)sender didSendPresence:(id)presence;

- (void)pbXmppStream:(STIMPBStream *)sender recordLog:(NSString *)log withDirection:(int)direction;

/**
 * These methods are called after failing to send the respective XML elements over the stream.
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didFailToSendIQ:(ProtoMessage *)iq error:(NSError *)error;

- (void)pbXmppStream:(STIMPBStream *)sender didFailToSendMessage:(ProtoMessage *)message error:(NSError *)error;

- (void)pbXmppStream:(STIMPBStream *)sender didFailToSendPresence:(ProtoMessage *)presence error:(NSError *)error;
 ...
 **/
- (void)pbXmppStreamWasToldToDisconnect:(STIMPBStream *)sender;

/**
 * This methods is called if the XMPP Stream's connect times out
 **/
- (void)pbXmppStreamConnectDidTimeout:(STIMPBStream *)sender;
 ...
 **/
- (void)pbXmppStreamDidDisconnect:(STIMPBStream *)sender withError:(NSError *)error;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didReceiveP2PFeatures:(ProtoMessage *)streamFeatures;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender willSendP2PFeatures:(ProtoMessage *)streamFeatures;
 ...
 **/
- (void)pbXmppStream:(STIMPBStream *)sender didRegisterModule:(id)module;

- (void)pbXmppStream:(STIMPBStream *)sender willUnregisterModule:(id)module;

- (void)pbXmppStreamEndStream:(STIMPBStream *)sender didReceiveMessgae:(ProtoMessage *)message;
