...
@implementation IMDataManager (STIMCalendar)
...
- (NSArray *)stIMDB_SelectTripByYearMonth:(NSString *)date {
    ...
    [[self dbInstance] inDatabase:^(STIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            [param setSTIMSafeObject:tripId forKey:@"tripId"];
            [param setSTIMSafeObject:tripName forKey:@"tripName"];
            [param setSTIMSafeObject:tripDate forKey:@"tripDate"];
            [param setSTIMSafeObject:tripType forKey:@"tripType"];
            [param setSTIMSafeObject:tripIntr forKey:@"tripIntr"];
            [param setSTIMSafeObject:tripInviter forKey:@"tripInviter"];
            [param setSTIMSafeObject:beginTime forKey:@"beginTime"];
            [param setSTIMSafeObject:endTime forKey:@"endTime"];
            [param setSTIMSafeObject:scheduleTime forKey:@"scheduleTime"];
            [param setSTIMSafeObject:appointment forKey:@"appointment"];
            [param setSTIMSafeObject:tripLocale forKey:@"tripLocale"];
            [param setSTIMSafeObject:tripLocaleNumber forKey:@"tripLocaleNumber"];
            
            [param setSTIMSafeObject:tripRoom forKey:@"tripRoom"];
            [param setSTIMSafeObject:tripRoomNumber forKey:@"tripRoomNumber"];
            [param setSTIMSafeObject:memberListJSON forKey:@"memberList"];
            [param setSTIMSafeObject:tripRemark forKey:@"tripRemark"];
            [param setSTIMSafeObject:canceled forKey:@"canceled"];
...
- (void)stIMDB_bulkInsertTrips:(NSArray *)trips {
    ...
    [[self dbInstance] syncUsingTransaction:^(STIMDataBase* _Nonnull database, BOOL * _Nonnull rollback) {
        ...
        STIMVerboseLog(@"result = :%d", result);
    }];
    STIMVerboseLog(@"");
}
...
- (NSArray *)stIMDB_getLocalArea {
    ...
    [[self dbInstance] inDatabase:^(STIMDataBase* _Nonnull database) {
        ...
        while ([reader read]) {
            ...
            NSMutableDictionary *param = [[NSMutableDictionary alloc] init];
            [param setSTIMSafeObject:areaId forKey:@"areaId"];
            [param setSTIMSafeObject:enable forKey:@"enable"];
            [param setSTIMSafeObject:areaName forKey:@"areaName"];
            [param setSTIMSafeObject:morningStarts forKey:@"morningStarts"];
            [param setSTIMSafeObject:eveningEnds forKey:@"eveningEnds"];
            [param setSTIMSafeObject:description forKey:@"description"];
            [areaList addObject:param];
        }
    }];
    STIMVerboseLog(@"");
