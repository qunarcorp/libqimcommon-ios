...
@interface STIMVoiceNoReadStateManager ()

@property (nonatomic, assign) BOOL isRead;

@end

static STIMVoiceNoReadStateManager *__voiceNoReadStateManager = nil;
static NSMutableDictionary *_voiceNoReadStateDict = nil;
@implementation STIMVoiceNoReadStateManager

+ (instancetype)sharedVoiceNoReadStateManager {
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        __voiceNoReadStateManager = [[STIMVoiceNoReadStateManager alloc] init];
    });
